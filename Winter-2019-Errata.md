...
-   [Chapter 5: Linear and nonlinear
    transformations](#chapter-5-linear-and-nonlinear-transformations)
...
|  193 | These mappings assign the y-minimum of the error bar to the lower-bound column from the sense\_preds tibble (`LB`), and the y-maximum of the error bar to the upper bound (`UB`) | `LB` and `UB` should be `lwr` and `upr`, respectively                             |
